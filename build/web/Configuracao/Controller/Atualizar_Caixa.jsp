  ...
  <body>
   ...
   <%
    ...
    if(flag){
             ...
             flag = cdao.atualiza(obj_Login_Bean);
     ...
     if(flag){
         ...
         response.setContentType("text/html");
            ...
            pw.println("alert('Caixa Atualizado com sucesso');");
            pw.println("</script>");
     }else{
         ...
         response.setContentType("text/html");
            PrintWriter pw=response.getWriter();
            pw.println("<script type=\"text/javascript\">");
            pw.println("alert('Erro ao atualizar Caixa');");
            pw.println("</script>");
     }
    %>
    <script type="text/javascript">
       window.location.href="http://localhost:8080/Alba/Configuracao/Atu_Caixas.jsp";
    </script>
  <%
}else{
            response.setContentType("text/html");
