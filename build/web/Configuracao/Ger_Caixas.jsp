 ...
 %>
            <!-- AREA DE AÇÃO -->
                <div  class="container-contact100">
                    <form class="contact100-form validate-form" id="formulario" name="formulario" autocomplete="off" action="../Configuracao/Controller/Cadastra_Caixa.jsp" method="POST">
			
		 <div  class="container-contact100">
		<div style="padding: 0; padding-left: 40px; float: left; width: 30%; display: inline-block;" class="wrap-contact100">
		<div style="padding: 0; padding-left: 20px; padding-bottom: 10px; float: left; width: 80%; display: inline-block;" class="wrap-contact100">
                    ...
                    <li style="margin-top: 0;">
                        ...
                        <select id="nome" name="loja" class="field-select">
                        <%for(Fiscal a : fdao.read()){%>
                        <option ><%=a.getNome() %></option>
                        <% } %>
                        </select>
                        <label>Caixa <span class="required"></span></label>
                        <input style="width: 100%;" id="descricao" type="text" name="idcaixa" class="field-divided" />	
                       <label>Operador <span class="required"></span></label>
                       <select id="nome" name="operador" class="field-select">
                       ...
                       <label>Senha <span class="required"></span></label>
                        <input style="width: 100%;" id="descricao" type="text" name="senha" class="field-divided" />	
                       <label>Série NFCE <span class="required"></span></label>
                        <input style="width: 100%;" id="descricao" type="text" name="serienfe" class="field-divided" />	
                        <a style="color: red;">Entre 000 e 800 </a>
                        <label>Série NFE<span class="required"></span></label>
                        <input style="width: 100%;" id="descricao" type="text" name="serienfce" class="field-divided" />	
                       <a style="color: red;">Entre 000 e 800 </a>
                       <input style="width: 100%; display: none;" id="funcao" type="text" name="funcao" />	
                       
                    </ul>
                    
                        <div style="padding-top: 0px; border-radius: 13px; height: 30px; margin-bottom: 15px; width: 18%" class="container-contact100-form-btn">
					<input id="ir" title="Salvar Caixa" class="contact100-form-btn" 
                                               style="color: #ffffff; 
                                               background: #fff;
